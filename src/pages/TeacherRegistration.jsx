  ...
  return (
    <div className="flex h-screen overflow-hidden relative">
      ...
      >
        <Navbar />
        <div className="mt-8">
          <h1 className="text-4xl font-semibold mb-6 text-center ">Teacher Registration</h1>
          <form className="grid grid-cols-2 gap-6 max-w-4xl mx-auto pt-10">
            ...
            <div>
              <label htmlFor="orgName" className="block text-base font-medium text-gray-700 mb-1">Institute Name</label>
